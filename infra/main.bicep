...
var storageName = buildProjectResourceName(abbrs.storageStorageAccounts, projectName, environmentName, resourceToken, false)
...
output STORAGE_URL string = storage.outputs.url
